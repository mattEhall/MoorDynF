   ...
   !print *, 'past echo bit'
    ...
    DO I = 1,p%NConnects
       ...
       IF ( other%ConnectList(I)%IdNum .NE. I ) THEN
         ErrMsg  = ' Connection node numbers must be sequential starting from 1.'
         CALL CleanUp()
         RETURN
       END IF
       ...
       IF ( ErrStat /= ErrID_None ) THEN
          ...
          ErrMsg  = ' Error reading Connections.'  ! would be nice to specify which line
          CALL CleanUp()
          RETURN
       END IF
    ...
    DO I = 1,p%NLines
       ...
       IF (scan( LineOutString, 'p') )  other%LineList(I)%OutFlagList(2) = 1 
       IF (scan( LineOutString, 'v') )  other%LineList(I)%OutFlagList(3) = 1
       IF (scan( LineOutString, 'U') )  other%LineList(I)%OutFlagList(4) = 1
       IF (scan( LineOutString, 'D') )  other%LineList(I)%OutFlagList(5) = 1
       IF (scan( LineOutString, 't') )  other%LineList(I)%OutFlagList(6) = 1
       IF (scan( LineOutString, 'c') )  other%LineList(I)%OutFlagList(7) = 1
       IF (scan( LineOutString, 's') )  other%LineList(I)%OutFlagList(8) = 1
       IF (scan( LineOutString, 'd') )  other%LineList(I)%OutFlagList(9) = 1
